...
<section class="slhe-section" id="<?php echo $uid; ?>">
    <div class="slhe-inline">
        <div class="slhe-lottie" aria-hidden="true">
            <?php if ( $lottie_desktop ) : ?>
                <div
                    class="slhe-lottie-player slhe-lottie-player--desktop"
                    data-lottie-url="<?php echo esc_url( $lottie_desktop ); ?>"
                ></div>
            <?php endif; ?>
            <?php if ( $lottie_mobile ) : ?>
                <div
                    class="slhe-lottie-player slhe-lottie-player--mobile"
...
(function () {
    ...
    var desktopPlayer = section.querySelector('.slhe-lottie-player--desktop');
    var mobilePlayer  = section.querySelector('.slhe-lottie-player--mobile');
    var activeAnim = null;
    ...
    function loadLottieLib(cb) {
        ...
        if (window.__slheLottieLoading) {
            window.__slheLottieLoading.push(cb);
            return;
        }
        window.__slheLottieLoading = [cb];
        var s = document.createElement('script');
        s.src = 'https://cdnjs.cloudflare.com/ajax/libs/lottie-web/5.12.2/lottie.min.js';
        s.async = true;
        s.onload = function () {
            var queue = window.__slheLottieLoading || [];
            delete window.__slheLottieLoading;
